...
interface ContainerCardConfig extends LovelaceCardConfig {
  columns?: LovelaceCardConfig[][] // Supports 1-4 columns
}
...
export function ContainerCard({
  ...
  const configTyped = config as ContainerCardConfig | undefined

  const renderRef = useRef(0)
  renderRef.current++

  // Memoize columns to prevent unnecessary re-renders
  const columns = useMemo(() => configTyped?.columns || [], [configTyped?.columns])
